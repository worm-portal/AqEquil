    ...
    def speciate(self,
        ...
        if get_affinity_energy:
            if rxn_filename == None:
                warnings.warn(
                    "A reaction file was not specified. Affinities and energy supplies will not be calculated.")
                get_affinity_energy = False
                rxn_filename = ""
                ...
                warnings.warn(
                    "Reaction file {} was not found. Affinities and energy supplies will not be calculated.".format(rxn_filename))
                get_affinity_energy = False
                rxn_filename = ""
        else:
            rxn_filename = ""
